...
/*Ham kien tra entry point open cua mylog driver */
...
/*Ham kiem tra entry point release cua mylog driver*/
void close_chardev(int fd)
{
    close(fd);
}

/*Ham kiem tra entry point read cua mylog driver */
...
/*Ham kiem tra entry point write cua mylog driver*/
