/*
 * Desc: chua cac dinh nghia mo ta thiet bi gia lap mylog_dev
 *       mylog_device la mot thiet bi gia, va no nam tren RAM
 */
#ifndef _MYLOG_DRIVER_H_
#define _MYLOG_DRIVER_H_
